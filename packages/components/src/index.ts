...
export { default as Autocomplete } from './base/components/Autocomplete.vue'
...
export { default as CopyText } from './base/components/CopyText.vue'
...
export { default as Embed } from './base/components/Embed.vue'
...
export { default as TagsInput } from './base/components/TagsInput.vue'
